/*
@name: 'roles\csat\csat_default.sqf'
@description: pool of potential items to generate for units of this role
...
@examples:
@returns: called as an #include within 'get_unitLoadout', therefore returns everything
*/

_headPool     = head_shemag
_facePool     = []
_uniformPool  = uniform_csat_basic
_vestPool     = []
_backpackPool = []
_weaponPool   = weapons_carbine + weapons_smg
