...
I_mas_BRDM2 // BEAUTIFUL interior
I_mas_BTR60 // see what else this author has made
...
// cars
CUP_Civ_Volha // use animation for this on other RDS civ vehicles, this is much cleaner
