...
<table class="table-light">
  <thead>
    <tr>
      <th width="200" class="name header">Feature</th>
      <th class="name header">Description</th>
      <th width="125" class="name header">Status</th>
    </tr>
  </thead>

  <tbody>
    <tr>
      <td class="name">Dynamic Units</td>
      <td>Groups of units spawn with random clothing, weapons, equipment and behaviors.</td>
      <td class="status complete">Complete</td>
    </tr>

    <tr>
      <td class="name">Area patrols</td>
      <td>Random enemy patrols will spawn around the player.</td>
    ...
    <tr>
      <td class="name">Construction</td>
      <td>Reshape your environment to stash supplies, provide shelter, or gain a necessary advantage when forced to halt the advance of an overwhelming enemy force. Facilitate larger operations by moving supplies via convoy or air transport.
      </td>
      <td class="status in-progress">In progress</td>
    </tr>

    <tr>
      <td class="name">Crafting</td>
      <td>Use of the crafting menu allows players to create tools, weapons, and structure or crafting components.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Dynamic objectives</td>
      <td>Players will receive random notifications of areas of interest, with each representing a dynamically generated encounter with unique requirements, enemies, and tactics.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Upgrades</td>
      <td>Combine collected scrap with other resources to reinforce and improve the features of vehicles, weapons, NPC underlings, equipment, structures, and constructed improvements.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Civilian Weapons</td>
      <td>New models and crafting recipes for many civilian weapons. Includes melee weapons, hunting rifles, bows & crossbows, handguns, automatic weapons, and makeshift explosives.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Civilian Items</td>
      <td>New models and crafting recipes for many civilian containers, tools, clothing, backpacking equipment, mountaineering gear, and objects of varying utility.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Civilian Vehicles</td>
      <td>New models and configurations for a number of common civilian vehicle types.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Support Requests</td>
      <td>Earn or purchase access to single-use support packages to receive short-term AI assistance at an important location.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">AI Behaviors & Tactics</td>
      <td>Encounter cunning enemy forces that react and redeploy to counter your actions.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Headless Client Modules</td>
      <td>Short: Faster server calculations. Long: Server calculations are split into HC modules that each process a particular aspect of the game, separate from all other components.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Defense system</td>
      <td>Survive deliberate enemy attacks on your compound.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Training & Experience</td>
      <td>Construct new improvements to train the members of your group, and even learn some new things yourself.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Mercenaries</td>
      <td>Recruit mercenaries with randomly generated gear and expertise. Armed to the teeth already? Earn some spending money through random contracts like convoy escorts or emplacement sabotage.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Raiding</td>
      <td>Secure key locations and defend supply convoys to secure valuable resources, or raid your enemies for theirs! Short on time? Destroy key enemy structures to render them useless until they are rebuilt - at the cost of resources.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Advanced Caching and Seeding</td>
      <td>Save computing resources by storing unused supplies, weapons, and vehicles in a virtual resource manifest while they continue to interact with the world through a common resource pool.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Recruitment</td>
      <td>Support, avoid, or engage organic groups of ai that evolve from civilians to resistance fighters, military conscripts, or anarchists based on their surroundings.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Night Operations</td>
      <td>Engage dynamic enemy forces that make intelligent use of the light to fight on their terms.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Drone Reconnaissance</td>
      <td>purchase UAVs, set them to patrol a map location, and view a live video feed from your UAV control console.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Perimeter Defense</td>
      <td>Craft new improvements to protect your territory.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Health & Fatigue</td>
      <td>Explore the world with new concerns for health conditions, ailments, fatigue, and weight capacity.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Transport System</td>
      <td>Purchase, borrow, or defend AI transports to a location.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Territories</td>
      <td>Valuable locations with unique resources, benefits, and inhabitants.</td>
      <td class="status not-started">Not started</td>
    </tr>

    <tr>
      <td class="name">Convoys</td>
      <td>Encounter groups of AI vehicles transporting valuable cargo...</td>
      <td class="status not-started">Not started</td>
    </tr>
  </tbody>
</table>
