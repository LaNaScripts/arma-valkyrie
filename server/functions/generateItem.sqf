...
switch _pool do {
  case "weapon": {
    #include "population\pools\equipment\weapons.sqf"
  };

  case "item": {
    #include "population\pools\equipment\items.sqf"
  };

  case "uniform": {
    #include "population\pools\equipment\uniforms.sqf"
  };

  case "ammo": {
    #include "population\pools\equipment\ammo.sqf"
  };
};
