...
// #include "population\encounters\civilian.sqf"
// #include "population\encounters\regime.sqf"
// #include "population\encounters\guerilla.sqf"
// #include "population\encounters\supplyDrop.sqf"
...
// global marker lists based on type
zonesCity = [
  #include "population\pools\zones\city.sqf"
];

zonesVillage = [
  #include "population\pools\zones\village.sqf"
];

zonesRural = [
  #include "population\pools\zones\rural.sqf"
];

zonesDesert = [
  #include "population\pools\zones\desert.sqf"
];

zonesMountain = [
  #include "population\pools\zones\mountain.sqf"
];
